...
export const SparklesIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6.343 6.343l-2.828 2.828M17.657 17.657l2.828 2.828M18 5h4M19 3v4M12 3v4M12 17v4M3 19h4M5 17v4M17.657 6.343l2.828-2.828M6.343 17.657l-2.828-2.828" />
    </svg>
);
...
export const ShareIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 4.186m0-4.186a2.25 2.25 0 110 4.186m2.923 2.923a2.25 2.25 0 100-4.186m0 4.186a2.25 2.25 0 110-4.186m0 0l-2.923-1.697m2.923-1.697a2.25 2.25 0 100-4.186m0 4.186a2.25 2.25 0 110-4.186m0 0l2.923 1.697m-2.923 1.697l2.923 1.697" />
    </svg>
);
